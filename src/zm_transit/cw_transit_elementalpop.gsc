...
main()
{
	...
	maps/mp/zombies/_zm_perks::register_perk_basic_info( "specialty_elementalpop", "elementalpop", 2000, &"ZOMBIE_PERK_DIVETONUKE", "zombie_perk_bottle_jugg" );
...
elementalpop_take()
{
	self IPrintLn("taken Elemental Pop");
}
